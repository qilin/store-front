...
export default {
  translation: {
    ...
    error_message: {
      ...
      'net::ERR_CONNECTION_REFUSED': 'It can be caused by incorrect firewall settings or server isn\'t available',
      'net::ERR_CONNECTION_RESET': 'Something happened that interrupted your connection',
      'net::ERR_CONNECTION_TIMED_OUT': 'The connection took too long. Your internet connection might be too slow, or the server might be too busy',
      'net::ERR_TIMED_OUT': 'The connection took too long. Your internet connection might be too slow, or the server might be too busy',
