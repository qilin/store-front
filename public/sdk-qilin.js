...
exports.FULLSCREEN_MODE_CHANGED = exports.ENABLE_FULLSCREEN = exports.PAYMENT_FORM_CLOSED = exports.SHOW_PAYMENT_FORM = void 0;
var SHOW_PAYMENT_FORM = 'SHOW_PAYMENT_FORM';
exports.SHOW_PAYMENT_FORM = SHOW_PAYMENT_FORM;
var PAYMENT_FORM_CLOSED = 'PAYMENT_FORM_CLOSED';
exports.PAYMENT_FORM_CLOSED = PAYMENT_FORM_CLOSED;
var ENABLE_FULLSCREEN = 'ENABLE_FULLSCREEN';
exports.ENABLE_FULLSCREEN = ENABLE_FULLSCREEN;
var FULLSCREEN_MODE_CHANGED = 'FULLSCREEN_MODE_CHANGED';
exports.FULLSCREEN_MODE_CHANGED = FULLSCREEN_MODE_CHANGED;
...
},{"./is":"cixp","process":"pBGv"}],"ZYOL":[function(require,module,exports) {
...
},{"./is":"cixp","./memo":"dPzZ","./misc":"CNBN","./string":"EomM"}],"bF34":[function(require,module,exports) {
"use strict";
...
},{"./logger":"ZYOL","./misc":"CNBN"}],"vnUD":[function(require,module,exports) {
"use strict";
...
},{"./async":"PHfu","./error":"IhUY","./is":"cixp","./logger":"ZYOL","./memo":"dPzZ","./misc":"CNBN","./object":"f2BT","./path":"bF34","./promisebuffer":"WUuT","./string":"EomM","./supports":"shUJ","./syncpromise":"EwT2"}],"OuCi":[function(require,module,exports) {
"use strict";
...
function () {
  function Span(_traceId, _spanId, _sampled, _parent) {
    if (_traceId === void 0) {
      _traceId = (0, _utils.uuid4)();
    }

    if (_spanId === void 0) {
      _spanId = (0, _utils.uuid4)().substring(16);
    }
...
},{"tslib":"vCxL","@sentry/utils":"vnUD","./span":"OuCi"}],"R95U":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "TRACEPARENT_REGEXP", {
  enumerable: true,
  get: function () {
    return _span.TRACEPARENT_REGEXP;
  }
});
...
var _span = require("./span");
},{"./scope":"RFfS","./hub":"R95U","./span":"OuCi"}],"uQ1D":[function(require,module,exports) {
"use strict";
...
},{"tslib":"vCxL","@sentry/hub":"U9M5"}],"qKFq":[function(require,module,exports) {
"use strict";
...
exports.Dsn = Dsn;
},{"tslib":"vCxL","@sentry/utils":"vnUD"}],"DsIj":[function(require,module,exports) {
"use strict";
...
exports.API = API;
},{"@sentry/utils":"vnUD","./dsn":"qKFq"}],"am9d":[function(require,module,exports) {
"use strict";
...
},{"tslib":"vCxL","@sentry/utils":"vnUD","./dsn":"qKFq","./integration":"am9d"}],"fec3":[function(require,module,exports) {
"use strict";
...
},{"@sentry/utils":"vnUD","./transports/noop":"fec3"}],"Bvms":[function(require,module,exports) {
"use strict";
...
function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } var cache = _getRequireWildcardCache(); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; if (obj != null) { var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
},{"@sentry/minimal":"uQ1D","@sentry/hub":"U9M5","./api":"DsIj","./baseclient":"AQrL","./basebackend":"BMjl","./dsn":"qKFq","./sdk":"Bvms","./transports/noop":"fec3","./integrations":"t1vy"}],"EptK":[function(require,module,exports) {
"use strict";
...
},{"@sentry/utils":"vnUD","./parsers":"kAUL","./tracekit":"EptK"}],"TRJV":[function(require,module,exports) {
"use strict";
        ...
        return tslib_1.__generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [4
              /*yield*/
              , global.fetch(this.url, defaultOptions)];
            ...
            case 3:
              ...
              if (status === _types.Status.RateLimit) {
                now = Date.now();
                this._disabledUntil = new Date(now + (0, _utils.parseRetryAfterHeader)(now, response.headers.get('Retry-After')));

                _utils.logger.warn("Too many requests, backing off till: " + this._disabledUntil);
              }
...
},{"tslib":"vCxL","@sentry/types":"vYhp","@sentry/utils":"vnUD","./base":"TRJV"}],"mwwI":[function(require,module,exports) {
"use strict";
...
},{"tslib":"vCxL","@sentry/types":"vYhp","@sentry/utils":"vnUD","./base":"TRJV"}],"iexI":[function(require,module,exports) {
"use strict";
...
},{"tslib":"vCxL","@sentry/core":"TZM3","@sentry/types":"vYhp","@sentry/utils":"vnUD","./eventbuilder":"yGRZ","./transports":"iexI"}],"Qr3a":[function(require,module,exports) {
"use strict";
...
},{"tslib":"vCxL","@sentry/core":"TZM3","@sentry/utils":"vnUD","./backend":"V30D","./version":"Qr3a"}],"PuX9":[function(require,module,exports) {
"use strict";
...
function breadcrumbEventHandler(eventName, debounce) {
  ...
  return function (event) {
    ...
    var captureBreadcrumb = function () {
      ...
      try {
        target = event.target ? (0, _utils.htmlTreeAsString)(event.target) : (0, _utils.htmlTreeAsString)(event);
      } catch (e) {
        target = '<unknown>';
      }
...
},{"@sentry/utils":"vnUD","../helpers":"PuX9"}],"YFxN":[function(require,module,exports) {
        ...
        return function (eventName, fn, options) {
          if (fn && fn.handleEvent) {
            ...
            if (eventName === 'keypress') {
              (0, _utils.fill)(fn, 'handleEvent', function (innerOriginal) {
                return function (event) {
                  (0, _helpers.keypressEventHandler)()(event);
                  return innerOriginal.call(this, event);
                };
              });
            }
  ...
  Breadcrumbs.prototype._instrumentFetch = function () {
    ...
    (0, _utils.fill)(global, 'fetch', function (originalFetch) {
      return function () {
        ...
        var fetchData = {
          method: (0, _utils.isString)(method) ? method.toUpperCase() : method,
          url: url
        };
  ...
  Breadcrumbs.prototype._instrumentXHR = function () {
    ...
    (0, _utils.fill)(xhrproto, 'open', function (originalOpen) {
      return function () {
        ...
        var url = args[1];
        this.__sentry_xhr__ = {
          method: (0, _utils.isString)(args[0]) ? args[0].toUpperCase() : args[0],
          url: args[1]
        };
        var client = (0, _core.getCurrentHub)().getClient();
        var dsn = client && client.getDsn();
        ...
        if (dsn) {
          ...
          if ((0, _utils.isString)(url) && filterUrl && url.indexOf(filterUrl) !== -1) {
...
},{"tslib":"vCxL","@sentry/core":"TZM3","@sentry/types":"vYhp","@sentry/utils":"vnUD","../helpers":"PuX9"}],"KquI":[function(require,module,exports) {
"use strict";
...
},{"tslib":"vCxL","@sentry/core":"TZM3","../parsers":"kAUL","../tracekit":"EptK"}],"wEu1":[function(require,module,exports) {
...
},{"./globalhandlers":"l5aE","./trycatch":"Q7DM","./breadcrumbs":"YFxN","./linkederrors":"KquI","./useragent":"wEu1"}],"nKpN":[function(require,module,exports) {
"use strict";
...
},{"@sentry/core":"TZM3","@sentry/utils":"vnUD","./client":"s6nm","./helpers":"PuX9","./integrations":"vue0"}],"cUe8":[function(require,module,exports) {
"use strict";
...
exports.Integrations = INTEGRATIONS;
},{"tslib":"vCxL","@sentry/types":"vYhp","@sentry/core":"TZM3","./client":"s6nm","./sdk":"nKpN","./version":"Qr3a","@sentry/utils":"vnUD","./integrations":"vue0","./transports":"iexI"}],"wr21":[function(require,module,exports) {
"use strict";
...
},{"@sentry/browser":"cUe8"}],"FgPl":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./logError":"wr21"}],"oVmq":[function(require,module,exports) {
"use strict";
...
var flashPluginKey = 'Shockwave Flash';

var _default = function _default() {
  try {
    var flashObjectIE = new window.ActiveXObject('ShockwaveFlash.ShockwaveFlash');
    if (flashObjectIE) return true;
  } catch (e) {
    return !!navigator.plugins && _typeof(navigator.plugins[flashPluginKey]) === 'object';
  }
...
exports.default = _default;
},{}],"lwy4":[function(require,module,exports) {
"use strict";
...
var _getAuthFunction = _interopRequireDefault(require("./getAuthFunction"));

var _logError = _interopRequireDefault(require("./logError"));

var _checkFlashEnabled = _interopRequireDefault(require("./checkFlashEnabled"));
...
var getQilinStore = function getQilinStore() {
  var queryString = window.location.href;
  var payFormCallback;
  var fullscreenCallback;
  var childFrame;
  var qilinProductUUID;
  var apiURL;
  var authFunction;

  var onPayFormClose = function onPayFormClose(frame, status) {
    var data = {
      type: _constants.PAYMENT_FORM_CLOSED,
      payload: {
        status: status
      }
    };
  ...
  var onShowPayForm = function onShowPayForm(callback) {
    payFormCallback = callback;
  };

  var onFullscreenModeEnabled = function onFullscreenModeEnabled(callback) {
    fullscreenCallback = callback;
  };

  var payFormListener = function payFormListener(event) {
    ...
    if (type !== _constants.SHOW_PAYMENT_FORM) return;
    var qilinProductUUID = payload.qilinProductUUID,
  ...
  var fullScreenListener = function fullScreenListener(event) {
    var _a = event.data,
        data = _a === void 0 ? {} : _a;
    var type = data.type;

    if (type === _constants.ENABLE_FULLSCREEN) {
      childFrame = event.source;
        ...
        switch (_a.label) {
          case 0:
            ...
            if (!qilinProductUUID || !apiURL) {
              error = new Error(apiURL ? 'Game UID is required, but not provided' : 'Api URL is required, but not provided');
              (0, _logError.default)(error);
              throw error;
            }

            authFunction = (0, _getAuthFunction.default)(apiURL);
            _a.label = 1;
  ...
  var setFullscreen = function setFullscreen(fullscreen) {
    if (!childFrame) return;
    var data = {
      type: _constants.FULLSCREEN_MODE_CHANGED,
      payload: {
  ...
  return {
    init: init,
    onShowPayForm: onShowPayForm,
    onFullscreenModeEnabled: onFullscreenModeEnabled,
    setFullscreen: setFullscreen,
    checkFlashEnabled: _checkFlashEnabled.default
  };
};

var _default = getQilinStore();

exports.default = _default;
},{"./constants":"eKDL","./getAuthFunction":"FgPl","./logError":"wr21","./checkFlashEnabled":"oVmq"}],"blxw":[function(require,module,exports) {
"use strict";
...
var getQilinGame = function getQilinGame() {
  var queryString = window.location.href;
  var callbacks = {};
  ...
  var dispatchEvent = function dispatchEvent(eventType, args) {
  ...
  var addCallback = function addCallback(eventType, callback) {
    var eventCallbacks = callbacks[eventType] || [];
    eventCallbacks.push(callback);
    callbacks[eventType] = eventCallbacks;
  };

  var showPaymentForm = function showPaymentForm(props) {
    ...
    var data = {
      type: _constants.SHOW_PAYMENT_FORM,
      payload: __assign({
        qilinProductUUID: qilinProductUUID
      }, props)
    };
  ...
  var enableFullscreenMode = function enableFullscreenMode() {
    if (!isGameInitialized) {
      alert('Game is not initialized!');
      return;
    }
    ...
    window.parent.postMessage({
      type: _constants.ENABLE_FULLSCREEN
    }, '*');
  };
  ...
  var init = function init(props) {
    return __awaiter(void 0, void 0, void 0, function () {
      var error, authFunction, meta, error_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            qilinProductUUID = props.qilinProductUUID;
          ...
          case 1:
            ...
            authFunction = props.onAuth || (0, _getAuthFunction.default)(apiURL);
            return [4
            /*yield*/
            , authFunction({
              meta: props.meta,
...
var _default = getQilinGame();

exports.default = _default;
},{"./constants":"eKDL","./getAuthFunction":"FgPl","./logError":"wr21"}],"QCba":[function(require,module,exports) {
"use strict";

var _qilinStore = _interopRequireDefault(require("./qilinStore"));

var _qilinGame = _interopRequireDefault(require("./qilinGame"));
...
if (!window) {
  var error = new Error('SDK only work on web browser');
  (0, _logError.default)(error);
  throw error;
}

window.qilinStore = _qilinStore.default;
window.qilinGame = _qilinGame.default;
window.PAYMENT_FORM_CLOSED = _constants.PAYMENT_FORM_CLOSED;
window.FULLSCREEN_MODE_CHANGED = _constants.FULLSCREEN_MODE_CHANGED;
},{"./qilinStore":"lwy4","./qilinGame":"blxw","./constants":"eKDL","./logError":"wr21"}]},{},["QCba"], null)
